...
import TranslateIcon from '@mui/icons-material/Translate'; import { useParams } from 'react-router-dom';
  ...
  return (
    <div style={{ 'margin': '2rem 2rem', 'padding': '2rem 2rem', 'borderRadius': '24px', 'backgroundColor': 'rgba(255, 153, 0, 0.05)', 'fontFamily': 'Inter' }}>
      ...
      <div style={{ 'display': 'flex', 'justifyContent': 'space-between', 'alignContent': 'center', 'color': 'black' }}>
        <p style={{ 'color': '#4B002D', 'fontSize': '24px', 'fontWeight': '600', 'lineHeight': '28px', 'padding': '1rem' }}>{epName} <span style={{ 'fontSize': '16px' }}>| {time} Minute Read</span></p>
          ...
          <div style={{ 'display': 'flex', 'justifyContent': 'center', 'alignContent': 'center', 'color': 'black' }}>
            ...
            <Menu
              ...
              <MenuItem onClick={() => setFontSize(18)}>
                <ListItemIcon>
                  <MDBIcon fas icon="font" />                </ListItemIcon>
      ...
      <div style={{ 'marginLeft': '4rem', 'margin': '2rem 4rem' }}>
        <img src={BASE_URL + "/episode/poster/" + epStory.posterImage} alt='Temple Poster'></img>
