...
import { loadEpisodeById } from "../services/EpisodeService";
  ...
  useEffect(() => {
    loadEpisodeById(id)
      .then((data) => {
        ...
        setEpStory(data);
        fetch(BASE_URL + "/episode/file/" + data.fileName)
          .then((res) => res.text())
          .then((md) => {
            setEpFile(md);
          })
  ...
  return (
    ...
    >
        ...
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb purple lighten-4">
            ...
            <li class="breadcrumb-item">
              <a
                class="black-text"
                href="/user/mythological-stories/episodes/25"
                style={{
                  color: "#4B002D",
                  fontSize: "15px",
                  lineHeight: "28px",
      ...
      >
        ...
        >
          {epStory.ep_number} <span style={{ 'fontSize': '16px' }}>| {time} Minute Read</span>
        </p>
        <div
          style={{
            display: "flex",
      ...
      <div style={{ marginLeft: "4rem", margin: "2rem 4rem" }}>
        <img src={BASE_URL + "/episode/poster/" + epStory.posterImage} alt='Episode Poster'></img>
        <p id="story" style={{ fontSize: `${fontSize}px`, margin: "2rem" }}>
          {/* {t(ti)} */}
